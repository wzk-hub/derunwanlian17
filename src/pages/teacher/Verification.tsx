...
const Verification = () => {
      ...
      if (currentUser) {
        ...
        if (currentUser.realName) {
          setFormData({
            ...
            qualificationCertificate: currentUser.qualificationCertificate || ''
          });
          ...
          if (currentUser.qualificationCertificate) setQualificationPreview(currentUser.qualificationCertificate);
        }
      } else {
        navigate('/login');
      }
  ...
  // 处理图片上传
  const handleFileUpload = (e: React.ChangeEvent<HTMLInputElement>, type: 'idFront' | 'idBack' | 'qualification') => {
    ...
    reader.onload = (event) => {
      ...
      switch (type) {
        ...
        case 'idBack':
          ...
          break;
        case 'qualification':
          setQualificationPreview(imageUrl);
          setFormData(prev => ({ ...prev, qualificationCertificate: imageUrl }));
          break;
      }
    };
  ...
  const validateForm = (): boolean => {
    ...
    if (!formData.qualificationCertificate) {
      newErrors.qualificationCertificate = '请上传教师资格证照片';
    }
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-md mx-auto">
          <div className="text-center mb-8">
            <h1 className="text-2xl font-bold text-gray-800">教师实名认证</h1>
            <p className="text-gray-500 mt-2">
              为了保障教学质量和学生权益，请完成教师实名认证
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-md overflow-hidden">
            <div className="p-6">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">
                    教师资格证照片 <span className="text-red-500">*</span>
                  </label>
                  ...
                  <div className="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center hover:bg-gray-50 transition-colors cursor-pointer">
                    {qualificationPreview ? (
                      <div className="relative">
                        ...
                        <button
                          ...
                          onClick={() => {
                            ...
                            setFormData(prev => ({ ...prev, qualificationCertificate: '' }));
                          }}
                          className="absolute top-2 right-2 bg-white rounded-full w-8 h-8 flex items-center justify-center shadow-md text-red-500"
                        >
                          <i className="fa-solid fa-times"></i>
                      ...
                      <label htmlFor="qualificationCertificate" className="cursor-pointer">
                        <div className="py-8">
                          <i className="fa-solid fa-cloud-upload text-3xl text-gray-400 mb-2"></i>
                          <p className="text-gray-500">点击上传教师资格证照片</p>
                          <p className="text-xs text-gray-400 mt-1">支持JPG、PNG格式，大小不超过5MB</p>
                        </div>
                        <input 
                          type="file" 
                  ...
                  {errors.qualificationCertificate && (
                    <p className="mt-1 text-sm text-red-600">{errors.qualificationCertificate}</p>
                  )}
                </div>
